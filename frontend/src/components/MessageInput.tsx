...
const MessageInput = ({ selectedUser, message, setMessage, handleMessageSend }: MessageInputProps) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-2 border-t border-gray-700 pt-4">
            {imageFile && (
            ...
            <div className="flex items-center gap-2">
                <label className="cursor-pointer bg-gray-800 hover:bg-gray-700 rounded-lg p-2.5 transition-colors border border-gray-700 flex items-center justify-center">
